# Structure of the Open Service Management Framework

## Disciplines

The OSMF is organized into a collection of "disciplines" (other frameworks call them "practices" or "processes").

We've tried to organize the disciplines in the order that most organizations tend to adopt them. For instance,
all organizations have some process for dealing with incidents, whether or not it's formalized, but might not
have a process for addressing problems or managing assets.

Examples of OSMF disciplines:
